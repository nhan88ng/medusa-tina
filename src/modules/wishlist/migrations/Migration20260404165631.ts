...
export class Migration20260404165631 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_wishlist_customer_product" ON "wishlist_item" ("customer_id", "product_id") WHERE deleted_at IS NULL;`);
  }
